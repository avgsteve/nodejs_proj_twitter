...
},{}],"../../server/socket.io/eventNames.js":[function(require,module,exports) {
exports.socketEventNames = {
  setupWebSocketConnection: "setupWebSocketConnection",
  startChatById: "startChatById",
  newChatMessageFromClient: "newChatMessageFromClient",
  newChatMessageToClient: "newChatMessageToClient",
  newNotificationFromClient: "newNotificationFromClient",
  newNotificationToClient: "newNotificationToClient"
};
},{}],"clientSideSocket.io/SocketIoController.js":[function(require,module,exports) {
"use strict";
...
var _eventNames = require("./../../../server/socket.io/eventNames.js");
...
var chatId = window.location.pathname.split('/')[3];

var SocketIoController = /*#__PURE__*/function () {
  // for debugging to check if singleton pattern works
  ...
  _createClass(SocketIoController, [{
    ...
    key: "establishSocketConnectionWithServer",
    value: function establishSocketConnectionWithServer() {
      var _this = this;

      this._socket.emit("setupWebSocketConnection", userLoggedIn);

      this._socket.on("connectedToServerSuccessful", function () {
        console.log('%c socket connection to server established!', 'background: #222; color: #bada55');
        _this._socketIsConnected = true;
      });

      this._socket.on("message received", function (newMessage) {
    ...
    key: "on",
    value: function on(eventName, eventCallbackForData) {
      this._socket.on(eventName, eventCallbackForData);
    }
  }, {
    key: "emitNoticeViaSocketToUser",
    value: function emitNoticeViaSocketToUser(recipientUserId) {
      console.log('emitNoticeViaSocketToUser to id:', recipientUserId);
      if (recipientUserId === userLoggedIn._id) return;
      this.emit(_eventNames.socketEventNames.newNotificationFromClient, recipientUserId);
    }
  }], [{
...
_defineProperty(SocketIoController, "_createdInstance", null);

_defineProperty(SocketIoController, "_createdInstanceCounter", 0);

var _default = SocketIoController;
exports.default = _default;
},{"./../../../server/socket.io/eventNames.js":"../../server/socket.io/eventNames.js"}],"GlobalControl/GlobalViewModel.js":[function(require,module,exports) {
"use strict";
...
var GlobalViewModel = /*#__PURE__*/function () {
  function GlobalViewModel() {
    var _this = this;

    _classCallCheck(this, GlobalViewModel);

    _defineProperty(this, "createChatHtml", function (chatData) {
      var chatName = chatData.chatName || 'New Chat';

      var chatRoomImage = _this._getChatImageElements(chatData);

      var latestMessage = _this._getLatestMessage(chatData.latestMessage);

      var activeClass = !chatData.latestMessage || chatData.latestMessage.readBy.includes(userLoggedIn._id) ? "" : "active";
      return "\n        <a href='/messages/".concat(chatData._id, "' class='resultListItem ").concat(activeClass, "'>\n            ").concat(chatRoomImage, "\n            <div class='resultsDetailsContainer ellipsis'>\n                <span class='heading ellipsis' >").concat(chatName, "</span>\n                <span class='subText ellipsis'>").concat(latestMessage, "</span>\n            </div>\n        </a>\n    ");
    });

    this.data = null;
  }

  _createClass(GlobalViewModel, [{
    key: "getUnreadNotifications",
    value: function getUnreadNotifications() {
      var showCountsOnly = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/notifications/unread?getOnlyCounts=".concat(showCountsOnly),
          method: 'GET',
    ...
    value: function getLastNotification() {
      return new Promise(function (res, rej) {
        $.ajax({
    ...
    key: "convertNoticeToPopupHtml",
    value: function convertNoticeToPopupHtml(notificationDoc) {
      if (!notificationDoc || !notificationDoc.userFrom) throw Error('incorrect notification data');
      var notificationSender = notificationDoc.userFrom;
      var activeIfNoticeWasOpened = notificationDoc.opened ? "" : "active";
      return "\n            <a\n                href='".concat(this.popupLinkFromNotice(notificationDoc), "'\n                class='resultListItem notification ").concat(activeIfNoticeWasOpened, "' \n                data-id='").concat(notificationDoc._id, "'\n            >\n\n                <div class='resultsImageContainer'>\n                    <img src='").concat(notificationSender.profilePic, "'>\n                </div>\n\n                <div class='resultsDetailsContainer ellipsis'>\n                    <span class='ellipsis popupNotificationText'>\n                      ").concat(this.popupContentFromNotice(notificationDoc), "\n                    </span>\n                </div>\n\n            </a>");
    } // Create link in popup notice to the page which the notice is for

  }, {
    key: "popupLinkFromNotice",
    value: function popupLinkFromNotice(noticeData) {
      var data = noticeData;
      var url = "#";

      if (data.notificationType == "retweet" || data.notificationType == "postLike" || data.notificationType == "reply") {
        url = "/posts/".concat(data.entityId);
      } else if (data.notificationType == "follow") {
        url = "/profile/".concat(data.entityId);
      }

      return url;
    }
  }, {
    key: "popupContentFromNotice",
    value: function popupContentFromNotice(noticeData) {
      var data = noticeData;
      var sender = data.userFrom;

      if (!sender.firstName || !sender.lastName) {
        return alert("user from data not populated");
      }

      var noticeSender = "".concat(sender.firstName, " ").concat(sender.lastName);
      var noticeMessage;

      if (data.notificationType == "retweet") {
        noticeMessage = "".concat(noticeSender, " retweeted one of your posts");
      }

      if (data.notificationType == "postLike") {
        noticeMessage = "".concat(noticeSender, " liked one of your posts");
      }

      if (data.notificationType == "reply") {
        noticeMessage = "".concat(noticeSender, " replied to one of your posts");
      }

      if (data.notificationType == "follow") {
        noticeMessage = "".concat(noticeSender, " followed you");
      }

      return "<span class='ellipsis'>".concat(noticeMessage, "</span>");
    }
  }, {
    key: "getUnreadChats",
    value: function getUnreadChats() {
      var showCountsOnly = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/chats/unread?getOnlyCounts=".concat(showCountsOnly),
          method: 'GET',
          success: function success(data, textStatus, jqXHR) {
            res(data);
          }
    ...
    key: "_getLatestMessage",
    value: function _getLatestMessage(latestMessage) {
      if (latestMessage != null) {
        var sender = latestMessage.sender;
        return "".concat(sender.firstName, " ").concat(sender.lastName, ": ").concat(latestMessage.content);
      }

      return "New chat";
    }
  }, {
    key: "_getChatImageElements",
    value: function _getChatImageElements(chatData) {
      var otherChatUsers = this._getOtherChatUsers(chatData.usersInChat);

      var groupChatClass = "";

      var chatImage = this._getUserChatImageElement(otherChatUsers[0]);
      ...
      return "<div class='resultsImageContainer ".concat(groupChatClass, "'>").concat(chatImage, "</div>");
    }
  }, {
    key: "_getOtherChatUsers",
    value: function _getOtherChatUsers(users) {
    ...
    key: "sideMenuIsOpened",
    value: function sideMenuIsOpened(isOpened) {
      var status = window.localStorage.getItem('keepSideMenuOpen');
      if (status === null) window.localStorage.setItem('keepSideMenuOpen', false);
      if (isOpened === undefined) return status; // return current saved value
      // Check type and use argument toggled to set the value of 'sideMenuToggled'

      if (typeof isOpened !== 'boolean') throw Error("parameter 'toggled' must be boolean type"); // update the value of key: 'keepSideMenuOpen' 
...
exports.default = GlobalViewModel;
...
},{"process":"../../node_modules/process/browser.js"}],"user/createUserHtml.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createUserHtml = createUserHtml;

function createUserHtml(userData, showFollowButton) {
  var userFullName = userData.firstName + " " + userData.lastName;
  var isFollowing = userLoggedIn.following && userLoggedIn.following.includes(userData._id);
  var ifIsFollowingText = isFollowing ? "Following" : "Follow"; // Follow button

  var buttonClass = isFollowing ? "followButton following" : "followButton";
  var followButton = "";

  if (showFollowButton && userLoggedIn._id != userData._id) {
    followButton = "\n        <div class='followButtonContainer'>\n            <button\n                class='".concat(buttonClass, "' \n                data-user='").concat(userData._id, "'\n            >\n            ").concat(ifIsFollowingText, "\n            </button>\n        </div>\n        ");
  }

  return "\n            <div class='user'>\n                <div class='profileImageContainer'>\n                    <img src='".concat(userData.profilePic, "'>\n                </div>\n                <div class='userDetailsContainer'>\n                    <div class='header'>\n                        <a href='/profile/").concat(userData.userName, "'>\n                            ").concat(userFullName, "\n                        </a>\n                        <span class='username'>@").concat(userData.userName, "</span>\n                    </div>\n                </div>\n                ").concat(followButton, "\n            </div>\n            ");
}
},{}],"chatList/ChatListModel.js":[function(require,module,exports) {
"use strict";
...
var _createUserHtml = require("../user/createUserHtml");
...
var ChatListModel = /*#__PURE__*/function () {
  function ChatListModel() {
    _classCallCheck(this, ChatListModel);
  }

  _createClass(ChatListModel, null, [{
    key: "searchUsersForNewChat",
    value: function searchUsersForNewChat(searchTerm) {
      return new Promise(function (res, rej) {
        $.get("/api/users", {
          searchTerm: searchTerm
        }, function (results) {
          res(results); // outputSelectableUsers(results, $(".resultsContainer"));
        }).fail(function (error) {
          var errorMessage = 'error while searching user for message:';
    ...
    key: "loadUnreadChatData",
    value: function loadUnreadChatData() {
      var showCountsOnly = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      return new Promise(function (res, rej) {
        try {
          $.get("/api/chats?unreadOnly=true&getUnreadCounts=".concat(showCountsOnly), function (data, status, xhr) {
    ...
    key: "chatListNotFoundMsg",
    value: function chatListNotFoundMsg() {
      return "\n          <div \n              class='noChatListDataFound' \n              style=\"\n                padding:3rem 1.5rem;  \n                font-size:2rem;    \n                color: grey;              \n              \"  \n          >\n              <p>\n                  No data found. Create a new chat ?\n              </p>\n          </div>\n      ";
    }
  }, {
    key: "coverImageFromChatUsers",
    value: function coverImageFromChatUsers(chatData) {
      var otherChatUsers = this.getOtherUsersFromChat(chatData.usersInChat);
      var imageTags = this.getUserImageTagForChat(otherChatUsers[0]);
      if (otherChatUsers.length > 1) imageTags += this.getUserImageTagForChat(otherChatUsers[1]);
      return "\n        <div\n            class='resultsImageContainer chatListCoverImages\n                  ".concat(otherChatUsers.length > 1 ? "groupChatImageContainer" : "", "'>\n            <!-- image tags are created by function \"coverImageFromChatUsers\" -->\n            ").concat(imageTags, "\n        </div>\n    ");
    }
  }, {
    key: "getOtherUsersFromChat",
    value: function getOtherUsersFromChat(users) {
      if (users.length === 1) return users;
      return users.filter(function (user) {
        return user._id != userLoggedIn._id;
      });
    ...
    key: "getUserImageTagForChat",
    value: function getUserImageTagForChat(user) {
      if (!user || !user.profilePic) return alert("The user argument passed into function is invalid");
      return "<img src='".concat(user.profilePic, "' alt='User's profile pic'>");
    }
  }, {
    key: "getChatNameFromDataOrUserNames",
    value: function getChatNameFromDataOrUserNames(chatData) {
      if (chatData.chatName) return chatData.chatName;

      if (!chatData.chatName) {
        var otherChatUsers = this.getOtherUsersFromChat(chatData.usersInChat);
        return otherChatUsers.map(function (user) {
          return user.firstName + " " + user.lastName;
        }).join(", ");
      }
    }
  }, {
    key: "latestMessageAsPreview",
    value: function latestMessageAsPreview(latestMessage) {
      if (latestMessage != null) {
        var user = latestMessage.sender;
        return "\n        ".concat(user.firstName, " ").concat(user.lastName, ": \n        ").concat(latestMessage.content, "\n      ");
      }
...
_defineProperty(ChatListModel, "createChatHtml", function (chatData) {
  var activeClass = !chatData.latestMessage || chatData.latestMessage.readBy.includes(userLoggedIn._id) ? "" : "active";
  return "\n      <a  href='/messages/chatRoom/".concat(chatData._id, "'       \n          class='resultListItem ").concat(activeClass, "' \n          >   \n              ").concat(ChatListModel.coverImageFromChatUsers(chatData), "\n              \n          <div class='resultsDetailsContainer ellipsis'>\n              <span \n                  class='heading ellipsis title-of-chat-in-list chat-name-from-data-or-users'>\n                  ").concat(ChatListModel.getChatNameFromDataOrUserNames(chatData), "\n              </span>\n              <span\n                  class='subText ellipsis chat-preview-text'>\n                  ").concat(ChatListModel.latestMessageAsPreview(chatData.latestMessage), "\n              </span>\n          </div>\n      </a>\n    ");
});

var _default = ChatListModel;
exports.default = _default;
},{"jquery":"../../node_modules/jquery/dist/jquery.js","../user/createUserHtml":"user/createUserHtml.js"}],"notification/NotificationModel.js":[function(require,module,exports) {
"use strict";
...
var NotificationModel = /*#__PURE__*/function () {
  function NotificationModel() {
    ...
    _defineProperty(this, "convertNoticeToPopupHtml", function (notification) {
      var userFrom = notification.userFrom;

      var text = _this.getNotificationText(notification);

      var href = _this.getNotificationUrl(notification); // If not opened, will have a blue background set in CSS by class .resultListItem.active


      var classNameForOpened = notification.opened ? "" : "active";
      return "\n      <a  href='".concat(href, "' \n          class='resultListItem notification ").concat(classNameForOpened, "' \n          data-id='").concat(notification._id, "'\n      >\n          <div class='resultsImageContainer'>\n              <img src='").concat(userFrom.profilePic, "'>\n          </div>\n          <div class='resultsDetailsContainer ellipsis'>\n              <span class='ellipsis'>").concat(text, "</span>\n          </div>\n      </a>");
    });
  }
  ...
  _createClass(NotificationModel, [{
    ...
    value: function getAllNotification() {
      return new Promise(function (res, rej) {
        $.get("api/notifications", function (data, status) {
          ...
          console.warn('ajax call for getAllNotification has failed! :', "Status: ".concat(jqXHR.statusCode, ". Reason: ").concat(jqXHR.responseText));
          rej(null);
        });
      });
    }
    ...
    value: function getNotificationText(notification) {
      var userFrom = notification.userFrom;
      ...
      var userFromName = "".concat(userFrom.firstName, " ").concat(userFrom.lastName);
      var text;

      if (notification.notificationType === "retweet") {
        text = "".concat(userFromName, " retweeted one of your posts");
      } else if (notification.notificationType === "postLike") {
        text = "".concat(userFromName, " liked one of your posts");
      } else if (notification.notificationType === "reply") {
        text = "".concat(userFromName, " replied to one of your posts");
      } else if (notification.notificationType === "follow") {
        text = "".concat(userFromName, " followed you");
      }
    ...
    value: function getNotificationUrl(notification) {
      var url = "#";

      if (notification.notificationType === "retweet" || notification.notificationType === "postLike" || notification.notificationType === "reply") {
        url = "/posts/".concat(notification.entityId);
      } else if (notification.notificationType === "follow") {
        url = "/profile/".concat(notification.entityId);
      }
    ...
    value: function getUnreadMessage() {
      return new Promise(function (res, rej) {
        try {
          $.get("/api/chats", {
            unreadOnly: true
    ...
    key: "markAllNotificationsOpened",
    value: function markAllNotificationsOpened() {
      return new Promise(function (res, rej) {
        $.ajax({
    ...
    key: "markNotificationsWithIdOpened",
    value: function markNotificationsWithIdOpened(notificationId) {
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/notifications/".concat(notificationId, "/markAsRead"),
          type: "PUT",
          success: function success(data, textStatus, jqXHR) {
            console.log("notification id: ".concat(notificationId, " is marked as opened!. Status: "), textStatus);
            res(true);
          },
          error: function error(jqXHR, exception) {
            console.warn('ajax call for getAllNotification has failed! :', "Status: ".concat(jqXHR.statusCode, ". Reason: ").concat(jqXHR.responseText));
...
},{}],"GlobalControl/GlobalView.js":[function(require,module,exports) {
"use strict";
...
var _NotificationModel = _interopRequireDefault(require("../notification/NotificationModel"));

var _GlobalViewModel = _interopRequireDefault(require("./GlobalViewModel"));
...
var GlobalView = /*#__PURE__*/function () {
  function GlobalView() {
    _classCallCheck(this, GlobalView);
  }

  _createClass(GlobalView, null, [{
    key: "showPreloaderInElement",
    value: function showPreloaderInElement(preloaderContainer) {
      var preloaderText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'default';
      var preloaderStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      if (!preloaderContainer) return; // check parameters' value

      var textToRender = typeof preloaderText === 'string' ? preloaderText : 'default';
      var loaderStyleNumber = typeof preloaderStyle === 'number' ? preloaderStyle : 0; // keep original html in case need to restore the button

      var originalHTML = preloaderContainer.html();
      var loaderElement; // message to show in preloader

      if (preloaderText !== 'default' && preloaderText !== "") {
      ...
      if (loaderStyleNumber === 0) loaderElement = "          \n        <div class='spinner_loader' \n            style=\"\n              width: 100%;\n              display: flex;\n              flex-direction: column;\n              align-items: center;\n              padding: 2rem;\n            \"\n        >\n\n            <div class=\"spinner-border text-center\" role=\"status\">\n                <span class=\"sr-only\">Loading...</span>\n            </div>          \n            <p> ".concat(textToRender, " </p>  \n        </div>\n      ");
      if (loaderStyleNumber === 1) loaderElement = "          \n        <div class=\"loader-container\">\n            <div class=\"loader7 loader\">\n            </div>\n            <p> ".concat(textToRender, " </p>              \n        </div>\n      ");
      preloaderContainer.html(loaderElement);
      return originalHTML;
    }
  }, {
    key: "removePreloaderInElement",
    value: function removePreloaderInElement() {
      var loaderElement = $('.loader-container');
    ...
    key: "showPreloadInButton",
    value: function showPreloadInButton(buttonElement, originalChildElement) {
      if (!buttonElement) return; // Make button restored to original style and content

      if (originalChildElement) return buttonElement.html(originalChildElement);
      var originalHTML = buttonElement.html(); // if (!element)
    ...
    key: "getRandomLoadingText",
    value: function getRandomLoadingText() {
      var randomText = ['Loading Awesome Content', 'Loading. Please BE PATIENT!', 'Loading. Won\'t be looooong', 'Loading...😺'];
    ...
    value: function showAlert() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          styleOption = _ref$styleOption === void 0 ? 0 : _ref$styleOption,
          _ref$message = _ref.message,
          message = _ref$message === void 0 ? 'alert message' : _ref$message,
          _ref$elementToShowAle = _ref.elementToShowAlert,
          elementToShowAlert = _ref$elementToShowAle === void 0 ? $(document.body) : _ref$elementToShowAle,
          _ref$timeToDisappear = _ref.timeToDisappear,
          timeToDisappear = _ref$timeToDisappear === void 0 ? 1000 : _ref$timeToDisappear,
          _ref$slideIn = _ref.slideIn,
          slideIn = _ref$slideIn === void 0 ? false : _ref$slideIn,
      ...
      var alertMessage = message || 'alert Message';
      var alertMarkup = "    \n        <div\n            class=\n              \" ".concat(slideIn === false ? "" : "slide-in", "\n                globalAlert alert\n                ").concat(alertStyle, "-alert\n              \"\n            >\n            <h3> ").concat(alertMessage, " </h3>\n            <a class=\"close\">&times;</a>\n        </div>\n    ");
    ...
    value: function () {
      var _refreshMessagesBadge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
        var numResults;
      ...
      function refreshMessagesBadge(_x) {
        return _refreshMessagesBadge.apply(this, arguments);
      }

      return refreshMessagesBadge;
    }()
  }, {
    key: "showNotificationPopup",
    value: function showNotificationPopup(noticeData) {
      var popupMarkup = _NotificationModel.default.convertNoticeToPopupHtml(noticeData);

      var element = $(popupMarkup); // convert to jQuery obj

      element.hide().prependTo("#popupNoticeContainer").slideDown("fast"); // Need to call .hide() before .slideDown

      setTimeout(function () {
        return element.fadeOut(400);
      }, 5000);
    } // Called by:GlobalViewController.showNoticeInPopup()

  }, {
    key: "showMessagePopup",
    value: function showMessagePopup(popupHtml) {
      var popupElement = $(popupHtml); // Need to set CSS for #popupNoticeContainer

      popupElement.hide().prependTo("#popupNoticeContainer").slideDown("fast");
      setTimeout(function () {
        return popupElement.fadeOut(400);
      }, 5000);
    }
  }, {
    key: "activateNotificationBadge",
    value: function activateNotificationBadge(unreadCounts) {
      return $("#notificationBadge").text(unreadCounts).addClass("active");
    }
  }, {
    key: "deactivateNotificationBadge",
    value: function deactivateNotificationBadge() {
      return $("#notificationBadge").text("").removeClass("active");
    }
  }, {
    key: "activateMessagesBadge",
    value: function activateMessagesBadge(unreadCounts) {
      return $("#messagesBadge").text(unreadCounts).addClass("active");
    }
  }, {
    key: "deactivateMessagesBadge",
    value: function deactivateMessagesBadge() {
      return $("#messagesBadge").text("").removeClass("active");
    }
  }, {
    key: "showMobileLayout",
    value: function showMobileLayout() {
      var activated = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      var navElement = $('.nav-col');
      var mainContainer = $('.mainSectionContainer ');
      var currentSideMenuIsOpen = window.localStorage.getItem('keepSideMenuOpen');
    ...
    key: "showSideMenu",
    value: function showSideMenu(active) {
      var navElement = $('.nav-col');
      var mainContainer = $('.mainSectionContainer ');
      var _2ColClass = 'col-2';
      var _10ColClass = 'col-10';
      var activeClass = 'active'; // When nav is active, make it inactive

      if (active && !navElement.hasClass(activeClass) // if already active , do nothing about it    
      ) {
          navElement.fadeIn();
      ...
      if (active === false) {
        navElement.fadeOut(); // Make main container full width
    ...
    key: "sideMenuBtn",
    value: function sideMenuBtn() {
      var active = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      if (active) $('.floatingMenuButtonContainer').addClass('active');
      if (!active) $('.floatingMenuButtonContainer').removeClass('active');
    }
  }]);
...
},{"../notification/NotificationModel":"notification/NotificationModel.js","./GlobalViewModel":"GlobalControl/GlobalViewModel.js"}],"GlobalControl/GlobalViewControl.js":[function(require,module,exports) {
"use strict";
...
var _ChatListModel = _interopRequireDefault(require("./../chatList/ChatListModel"));

var _GlobalView = _interopRequireDefault(require("./GlobalView"));
...
var GlobalViewControl = /*#__PURE__*/function () {
  function GlobalViewControl(checkForSingletonInstance) {
    _classCallCheck(this, GlobalViewControl);
  ...
  _createClass(GlobalViewControl, [{
    key: "refreshNotificationsBadge",
    value: function () {
      var _refreshNotificationsBadge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var unreadCounts;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return globalViewModel.getUnreadNotifications();

              case 2:
                unreadCounts = _context.sent;
                ...
                return _context.abrupt("return", _GlobalView.default.activateNotificationBadge(unreadCounts));

              case 5:
                _GlobalView.default.deactivateNotificationBadge();
      ...
      function refreshNotificationsBadge() {
        return _refreshNotificationsBadge.apply(this, arguments);
      }

      return refreshNotificationsBadge;
    }()
  }, {
    key: "refreshMessagesBadge",
    value: function () {
      var _refreshMessagesBadge = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return _ChatListModel.default.loadUnreadChatData(true);

                        case 2:
                          unreadCounts = _context2.sent;
                          ...
                          return _context2.abrupt("return", _GlobalView.default.activateMessagesBadge(unreadCounts));

                        case 5:
                          _GlobalView.default.deactivateMessagesBadge();
    ...
    key: "showNoticeInPopup",
    value: function () {
      var _showNoticeInPopup = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var latestNoticeData, popupMarkup;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return globalViewModel.getLastNotification();

              case 2:
                latestNoticeData = _context4.sent;
                popupMarkup = globalViewModel.convertNoticeToPopupHtml(latestNoticeData);

                _GlobalView.default.showMessagePopup(popupMarkup);
      ...
      function showNoticeInPopup() {
        return _showNoticeInPopup.apply(this, arguments);
      }

      return showNoticeInPopup;
    }()
  }, {
    key: "mobileLayoutUnderWidth",
    value: function mobileLayoutUnderWidth() {
      var threshold = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 480;

      if ($(window).width() < threshold) {
        _GlobalView.default.showMobileLayout(true);
      } else {
        _GlobalView.default.showMobileLayout(false);
      }
    ...
    key: "draggableElements",
    value: function draggableElements() {
      $(function () {
    ...
    value: function toggleSideMenu() {
      $('.sideMenuToggleBtn').on('click', function () {
        if ($('.nav-col').hasClass('active')) {
          _GlobalView.default.showSideMenu(false);

          window.localStorage.setItem('keepSideMenuOpen', false); // console.log('sideMenuStatus: ', window.localStorage.getItem('keepSideMenuOpen'));

          return;
        }

        _GlobalView.default.showSideMenu(true);

        window.localStorage.setItem('keepSideMenuOpen', true); // console.log('sideMenuStatus: ', window.localStorage.getItem('keepSideMenuOpen'));
      });
    }
  }], [{
    ...
    value: function getSingletonInstance() {
      ...
      var instance = new GlobalViewControl(true);
      this.createdInstance = instance;
      return this.createdInstance;
    }
  }]);

  return GlobalViewControl;
}();

exports.default = GlobalViewControl;

_defineProperty(GlobalViewControl, "createdInstance", null);
},{"./GlobalViewModel":"GlobalControl/GlobalViewModel.js","./../chatList/ChatListModel":"chatList/ChatListModel.js","./GlobalView":"GlobalControl/GlobalView.js"}],"GlobalControl/GlobalSocketEventsHandler.js":[function(require,module,exports) {
"use strict";
...
var _SocketIoController = _interopRequireDefault(require("../clientSideSocket.io/SocketIoController"));

var _eventNames = require("../../../server/socket.io/eventNames");

var _GlobalViewControl = _interopRequireDefault(require("./../GlobalControl/GlobalViewControl"));
...
var socket = _SocketIoController.default.getCreatedInstance(); // Mapping client side event name to server side event name 
// (in case of typo)


var globalViewControl = _GlobalViewControl.default.getSingletonInstance();

var GlobalSocketEventsHandler = /*#__PURE__*/function () {
  function GlobalSocketEventsHandler() {
    _classCallCheck(this, GlobalSocketEventsHandler);

    this.initSocketEventHandler();
  }

  _createClass(GlobalSocketEventsHandler, [{
    key: "initSocketEventHandler",
    value: function initSocketEventHandler() {
      this.event_newMessageToClient();
      this.event_newNotificationToClient();
    } // === Handler for receiving a new message ===

  }, {
    key: "event_newMessageToClient",
    value: function event_newMessageToClient() {
      socket.on(_eventNames.socketEventNames.newChatMessageToClient, function (newMessage) {
        console.log('New chat message received by global socket event handler ! ', newMessage); // no need to update MessagesBadge if the user is
        ...
        if (!chatIdMatchesCurrentChatRoomId(newMessage)) {
          ...
          globalViewControl.refreshMessagesBadge(); // Note: No to show popup for messages as there might be too many messages sending at the same time
    ...
    key: "event_newNotificationToClient",
    value: function event_newNotificationToClient() {
      socket.on(_eventNames.socketEventNames.newNotificationToClient, function (notificationData) {
        console.log('New notificationData received by global socket event handler ! ', notificationData); // update notification Badge
  ...
  return GlobalSocketEventsHandler;
}(); // Check if received message is for current chat room by checking url


exports.default = GlobalSocketEventsHandler;

function chatIdMatchesCurrentChatRoomId(newMessage) {
  if (!newMessage) return false;
  var currentUrl = window.location.pathname;
  if (newMessage.chat && currentUrl.includes(newMessage.chat._id)) return true;
  return false;
}
},{"../clientSideSocket.io/SocketIoController":"clientSideSocket.io/SocketIoController.js","../../../server/socket.io/eventNames":"../../server/socket.io/eventNames.js","./../GlobalControl/GlobalViewControl":"GlobalControl/GlobalViewControl.js"}],"post/PostHTMLCreator.js":[function(require,module,exports) {
"use strict";
...
var PostHTMLCreator = /*#__PURE__*/function () {
  function PostHTMLCreator() {
    _classCallCheck(this, PostHTMLCreator);
  }

  _createClass(PostHTMLCreator, null, [{
    key: "timestampWithTimeDifference",
    value: function timestampWithTimeDifference(currentTime, previous) {
      ...
      var elapsed = currentTime - previous;
    ...
    key: "createPostHeaderButtons",
    value: function createPostHeaderButtons(buttonType, postDataToConvert, userLoggedIn) {
      if (!buttonType || !postDataToConvert || !userLoggedIn) {
        console.log('error in createPostHeaderButtons function. Please check arguments');
        return "";
      }

      if (postDataToConvert.postedBy._id !== userLoggedIn._id) return ""; // Pinned Post Icon

      if (buttonType === this.buttonTypes.pinnedPostTextOnTop) {
        var pinnedPostIconTag = "";
      ...
      if (buttonType === this.buttonTypes.postHeaderButtons) {
        var postHeaderButton = '';
        var pinnedClass = '';
        var bootStrapModalTarget = "#confirmPinModal";
        ...
        postHeaderButton = "\n      <!-- == \u5C07\u6587\u7AE0\u7F6E\u9802\u7684\u6309\u9215  == -->\n      <button class='pinButton ".concat(pinnedClass, "' \n              data-id=\"").concat(postDataToConvert._id, "\" data-toggle=\"modal\"\n              data-target=\"").concat(bootStrapModalTarget, "\">\n          <i class='fas fa-thumbtack'></i>\n      </button>\n\n      <!-- == \u522A\u9664\u6587\u7AE0\u7684\u6309\u9215 event: postController -> deletePost()  == -->\n      <button\n              class='btn_openDeleteModal'\n              data-id=\"").concat(postDataToConvert._id, "\"\n              data-toggle=\"modal\"\n              data-target=\"#deletePostModal\">\n          <i class='fas fa-times'></i>\n      </button>\n    ");
        return postHeaderButton;
      }
    }
  }, {
    key: "getRetweetText",
    value: function getRetweetText(isA_RetweetPost, userNameOfRetweeter) {
      if (!isA_RetweetPost) return "";
      return "\n      <span>\n          <i class='fas fa-retweet'></i>\n            Retweeted by\n          <a href='/profile/".concat(userNameOfRetweeter, "'>\n            @").concat(userNameOfRetweeter, "\n          </a>\n      </span>\n    ");
    }
  }]);

  return PostHTMLCreator;
}();

exports.default = PostHTMLCreator;

_defineProperty(PostHTMLCreator, "buttonTypes", {
  pinnedPostTextOnTop: "pinnedPostTextOnTop",
  postHeaderButtons: "postHeaderButtons"
});

_defineProperty(PostHTMLCreator, "convertPostToHtml", function (postDataToConvert) {
  var largeFont = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  if (postDataToConvert === null || postDataToConvert === undefined) return console.error("post object is null or undefined:", postDataToConvert);
  if (Array.isArray(postDataToConvert)) return console.error("can't process postDataToConvert obj as an array:", postDataToConvert);

  var _variablesFromPostDat = variablesFromPostData(postDataToConvert, userLoggedIn // global variable predefined in main-layout.pug
  ),
      postCreator = _variablesFromPostDat.postCreator,
      is_a_reply_post = _variablesFromPostDat.is_a_reply_post,
      isA_RetweetPost = _variablesFromPostDat.isA_RetweetPost,
      userNameOfRetweeter = _variablesFromPostDat.userNameOfRetweeter,
      postHasBeenLiked = _variablesFromPostDat.postHasBeenLiked,
      postHasBeenRetweeted = _variablesFromPostDat.postHasBeenRetweeted; // Use "isA_RetweetPost" variable to tell if this post is a REPLY or a RETWEET


  postDataToConvert = isA_RetweetPost ? postDataToConvert.isRetweetToPost : postDataToConvert; // Optional class will be used in HTML    

  var tag_replyingToPost = ""; // Check if the field ".isReplyToPost" is populated if it's a REPLY 
...
function variablesFromPostData(postDataToConvert, userLoggedIn) {
  if (postDataToConvert === null || postDataToConvert === undefined) throw Error("post object is null");

  if (postDataToConvert.postedBy._id === undefined) {
    throw Error("User object not populated");
  }

  var isA_RetweetPost = postDataToConvert.isRetweetToPost !== undefined;
  return {
...
function is_a_reply_post(postDataToConvert) {
  if (postDataToConvert.isReplyToPost && postDataToConvert.isReplyToPost._id) return true;
  return false;
}
...
function checkIfOriginalPostIsPopulated(postDataToConvert) {
  ...
  if (!postDataToConvert.isReplyToPost._id) throw Error("The original post for this Reply is not populated");
  if (!postDataToConvert.isReplyToPost.postedBy._id) throw Error("The creator of this original post for this Reply is not populated");
}

function generateReplyMarkupForReply(postDataToConvert) {
  var userNameFromReply = postDataToConvert.isReplyToPost.postedBy.userName;
  var tag_replyingToPost = "\n        <div class='tag_replyingToPost'>\n            Replying to\n            <a href='/profile/".concat(userNameFromReply, "'>\n              @").concat(userNameFromReply, "\n            <a>\n        </div>\n      ");
...
},{}],"post/PostModel.js":[function(require,module,exports) {
"use strict";
...
var PostModel = /*#__PURE__*/function () {
  ...
  _createClass(PostModel, [{
    ...
    key: "getAllPostsWithOption",
    value: function getAllPostsWithOption(queryObj) {
      var queryOption = queryObj || {
      ...
      return new Promise(function (res, rej) {
        $.ajax({
          ...
          type: "GET",
          data: queryOption,
          success: function success(allPosts) {
            res(allPosts);
          }
        }).fail(function (data, textStatus, xhr) {
    ...
    key: "createRetweetToPost",
    value: function createRetweetToPost(postId) {
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/posts/".concat(postId, "/retweet"),
          type: "POST",
          success: function success(updatedOriginalPost) {
    ...
    key: "createNewPost",
    value: function createNewPost(dataOfNewPost) {
      return new Promise(function (res, rej) {
        $.ajax({
          type: "POST",
          url: "/api/posts/",
    ...
    key: "getContainerWithClass",
    value: function getContainerWithClass() {
      var containerClassName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'postsContainer';
      var $container = $('.' + containerClassName); // Check: Must have a container to render post

      if ($container.length === 0) return console.error("The element with class name \".".concat(containerClassName, "\" is not found in the page to render posts"));
      return $container;
    }
  }, {
    key: "getPostIdFromUrl",
    value: function getPostIdFromUrl() {
      var currentPagePath = window.location.pathname;
      var postIdFromUrl = currentPagePath.split('/')[2];
      if (!postIdFromUrl) throw Error("Can't find post id in URL. Current Url path: ".concat(currentPagePath));
      return postIdFromUrl;
    }
  }, {
    key: "getPostIdFromElement",
    value: function getPostIdFromElement(element) {
    ...
    key: "getPostIdFromReplyBtn",
    value: function getPostIdFromReplyBtn(buttonClicked) {
      if (!buttonClicked) return console.error("buttonClicked id is null");
      var postIdFromReplyButton = buttonClicked.data().id;
      if (!postIdFromReplyButton) return console.error("post id is not found in reply button");
      return postIdFromReplyButton;
    }
  }, {
    key: "locateInputField",
    value: function locateInputField(newPostIsReply) {
      if (newPostIsReply) return $("#replyTextarea");
      return $("#postTextarea");
    }
  }, {
    key: "sendDeletePostRequest",
    value: function sendDeletePostRequest(postId) {
      if (!postId) return console.log('no postId received in sendDeletePostRequest function');
      return new Promise(function (res, rej) {
        try {
          $.ajax({
            url: "/api/posts/".concat(postId),
            ...
            success: function success(data, status, xhr) {
              if (xhr.status != 204) {
                alert("could not delete post, postID: ".concat(postID, " "));
                res(false);
              }
    ...
    key: "sendPinPostRequest",
    value: function sendPinPostRequest(postId) {
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/posts/".concat(postId),
          type: "PUT",
    ...
    key: "sendUnpinPostRequest",
    value: function sendUnpinPostRequest(postId) {
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/posts/".concat(postId),
          type: "PUT",
    ...
    key: "sendLikePostRequest",
    value: function sendLikePostRequest(postId) {
      if (!postId) return console.log('no postId received in sendDeletePostRequest function');
      return new Promise(function (res, rej) {
        try {
          $.ajax({
            ...
            success: function success(data, status, xhr) {
              if (xhr.status != 200) {
                alert("could not like post, postID: ".concat(postID, " "));
                res(false);
              }
...
},{}],"post/PostView.js":[function(require,module,exports) {
"use strict";
...
var PostView = /*#__PURE__*/function () {
  ...
  _createClass(PostView, [{
    ...
    set: function set(likedPostData) {
    ...
    value: function showPreloaderInElement(preloaderContainer) {
      var preloaderText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'default';
      var preloaderStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      if (!preloaderContainer) return; // preloaderText must be text otherwise make it default

      var textToRender = typeof preloaderText === 'string' ? preloaderText : 'default'; // 

      var loaderStyleNumber = typeof preloaderStyle === 'number' ? preloaderStyle : 0; // 保存下來原本的HTML    

      var originalHTML = preloaderContainer.html();
      var loaderElement; // loading的時候要顯示的訊息
    ...
    key: "showFinishMessage",
    value: function showFinishMessage(elementToShowMessage) {
      var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      if (!elementToShowMessage) return;
      var messageElement = $("<p class= 'text-center'> </>");
      var messageText = message === "" ? 'Success!' : message.toString().trim();
      elementToShowMessage.html(messageElement.text(messageText));
    }
  }, {
    key: "disableSubmitBtnEvent",
    value: function disableSubmitBtnEvent() {
      return $("#postTextarea, #replyTextarea").keyup(function (event) {
        var textbox = $(event.target);
        var value = textbox.val().trim();
        var isModal = textbox.parents("#replyModal").length === 1; // 如果有class 為 .modal的 parent元素↑↑，就判斷↓↓為回覆文章用的 modal (id=submitReplyButton)
    ...
    key: "removeAnyNoResultMarkupAndShowPreloader",
    value: function removeAnyNoResultMarkupAndShowPreloader() {
      var noResultsMarkup = $('.noResults');

      if (noResultsMarkup.length !== 0) {
        noResultsMarkup.html(""); // Show preloader as the container will be empty

        _GlobalView.default.showPreloaderInElement($('.postsContainer'), 'Refreshing Page', 1);
      }
    }
  }, {
    key: "updateUiAfterNewPostIsCreated",
    value: function updateUiAfterNewPostIsCreated(inputField, buttonClicked, originalBtnHtml) {
      inputField.val("");
      buttonClicked.html(originalBtnHtml);
      $('#replyModal').modal('hide');

      _GlobalView.default.removePreloaderInElement();
    }
  }, {
    key: "restoreLikeBtnHtml",
    value: function restoreLikeBtnHtml() {
      this.clickedLikeBtn.html(this.originalBtnHtml);
    }
  }, {
    key: "updateLikeBtn",
    value: function updateLikeBtn() {
      this.clickedLikeBtn.find("span").text(this.likedPostData.likes.length || "");
    }
  }, {
    key: "activateLikeBtn",
    value: function activateLikeBtn() {
      this.clickedLikeBtn.addClass("active");
      this.clickedLikeBtn.attr('title', 'Click to unlike this post');
    }
  }, {
    key: "deactivateLikeBtn",
    value: function deactivateLikeBtn() {
      this.clickedLikeBtn.removeClass("active");
      this.clickedLikeBtn.attr('title', 'Click to liked this post');
    }
  }, {
    key: "outputPostHTMLInContainer",
    value: function outputPostHTMLInContainer() {
      var postHTML = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var elementToRenderPost = arguments.length > 1 ? arguments[1] : undefined;
      var messageWhenNoResults = arguments.length > 2 ? arguments[2] : undefined;
      var container = elementToRenderPost || $(".postsContainer");
      var noResultsFoundMessage = messageWhenNoResults || 'No Post Found. Create New Post?';
      container.html("");
      if (Array.isArray(postHTML) && postHTML.length === 0) return container.append("<p class='noResults'>".concat(noResultsFoundMessage, "</p>"));
      if (Array.isArray(postHTML) && postHTML.length !== 0) return postHTML.forEach(function (html) {
...
},{"./../GlobalControl/GlobalView":"GlobalControl/GlobalView.js"}],"post/postController.js":[function(require,module,exports) {
"use strict";
...
var _PostHTMLCreator = _interopRequireDefault(require("./PostHTMLCreator"));
...
var socket = _SocketIoController.default.build_singleton_instance();

var postModel = new _PostModel.default();
var postView = new _PostView.default();
var currentPagePath = window.location.pathname;
...
var PostController = /*#__PURE__*/function () {
  function PostController() {
    ...
    _defineProperty(this, "event_disableSubmitBtnInTextArea", function () {
      // 輸入區塊沒有文字的時候不能送出 submit form 的動作
      postView.disableSubmitBtnEvent();
    });

    _defineProperty(this, "event_openReplyPostModal", function () {
      // 點擊回覆按鈕之後，在modal上方的 #originalPostContainer 顯示要回覆的文章
      $("#replyModal").on("show.bs.modal", /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
          var button, postIdToReply, originalPostContainer, data, originalPostHtml;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  button = $(event.relatedTarget);
                  postIdToReply = postModel.getPostIdFromElement(button);
                  originalPostContainer = $("#originalPostContainer");
                  $("#submitReplyButton").data("id", postIdToReply);
                  postView.showPreloaderInElement(originalPostContainer, 'loading original post...'); // postModel.sendPostReply(postIdToReply, originalPostContainer);

                  _context.next = 7;
                  return postModel.getPostById(postIdToReply);

                case 7:
                  data = _context.sent;

                  if (data.postData) {
                    originalPostHtml = _PostHTMLCreator.default.convertPostToHtml(data.postData);
                    postView.outputPostHTMLInContainer(originalPostHtml, $("#originalPostContainer"));
                  }
      ...
      $("#replyModal").on("hidden.bs.modal", function () {
        return $("#originalPostContainer").html("");
      });
    });
  ...
  _createClass(PostController, [{
    key: "initPostEventListener",
    value: function initPostEventListener() {
      var listenersToInit = this.getEventListeners();

      var _iterator = _createForOfIteratorHelper(listenersToInit),
          _step;
    ...
    value: function getEventListeners() {
      return [this.event_clickOnPost, this.event_deletePost, this.event_pinPostEvent, this.event_unpinPost, this.event_disableSubmitBtnInTextArea, this.event_openReplyPostModal, this.event_submitPost, this.event_clickLikeButton, this.event_clickRetweetButton];
    }
  }, {
    key: "renderAllPostInPage",
    value: function renderAllPostInPage() {
      $( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var $postContainer, allPostsData, postsHtmlArray;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                $postContainer = postModel.getContainerWithClass("postsContainer");
                postIdFromURL = postModel.getPostIdFromUrl();
                _context4.next = 4;
                return postModel.getPostById(postIdFromURL);

              case 4:
                postDataById = _context4.sent;

                if (postDataById.postData) {
                  _context4.next = 7;
                  break;
                }

                return _context4.abrupt("return", $postContainer.html("\n        <p class='noResults'>\n            (\xB0\u30ED\xB0) <br>\n            The post with id: ".concat(postIdFromURL, " is not found or deleted\n        </p>\n        ")));
    ...
    key: "event_clickOnPost",
    value: // 按下 .post 元素後 之後將使用者轉向 /post/postId 頁面
    function event_clickOnPost() {
      $(document).on("click", ".post", function (e) {
        var clickedElement = $(e.target);
        var postId = postModel.getPostIdFromElement(clickedElement);
    ...
    value: function event_deletePost() {
      // 開啟刪除文章確認的 modal:  createPostHTML
      $("#deletePostModal").on("show.bs.modal", function (event) {
        // 取得 按下 .btn_openDeleteModal 的時候，所點擊的元素:  event.relatedTarget
        var btn_openDeleteModal = $(event.relatedTarget);
        var postId = postModel.getPostIdFromElement(btn_openDeleteModal); // 將 postId 寫入 確認刪除按鈕的 data attribute
    ...
    key: "event_pinPostEvent",
    value: function event_pinPostEvent() {
      // 1) 開啟確認文章置頂的 modal，
              ...
              switch (_context9.prev = _context9.next) {
                ...
                case 7:
                  ...
                  if (updated_retweetedPost.retweetUsers.includes(userLoggedIn._id)) {
                    ...
                    socket.emitNoticeViaSocketToUser(updated_retweetedPost.postedBy); // emitNotification(postData.postedBy);
                  } else {
...
function renderPostDataInPostIdPage(postDataById) {
  var container = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $(".postsContainer");
  container.html(""); // console.log('傳進renderPostDataInPostIdPage的 Results: ', postDataById);

  if (ifIsReplyPost(postDataById.postData)) {
    console.log('render results.isReplyToPost: ');

    var html = _PostHTMLCreator.default.convertPostToHtml(postDataById.postData.isReplyToPost);

    container.append(html);
  }

  var mainPostHtml = _PostHTMLCreator.default.convertPostToHtml(postDataById.postData, true // "largeFont: true" will enlarge the font for main post selected
  );

  container.append(mainPostHtml);
  postDataById.replies.forEach(function (result) {
    var html = _PostHTMLCreator.default.convertPostToHtml(result);
...
exports.outputUsersInContainer = outputUsersInContainer;

var _require = require('./createUserHtml'),
    createUserHtml = _require.createUserHtml;

function outputUsersInContainer(results, container) {
  container.html("");
...
},{"./createUserHtml":"user/createUserHtml.js"}],"search/searchPageModel.js":[function(require,module,exports) {
"use strict";
...
var SearchPageModel = /*#__PURE__*/function () {
  function SearchPageModel() {
    _classCallCheck(this, SearchPageModel);
  }
...
var _default = SearchPageModel;
exports.default = _default;
},{}],"search/searchPageView.js":[function(require,module,exports) {
"use strict";
...
var SearchPageView = /*#__PURE__*/function () {
  function SearchPageView() {
    _classCallCheck(this, SearchPageView);
  }

  _createClass(SearchPageView, null, [{
    key: "showSearchPreloader",
    value: function showSearchPreloader(elementToShowReloader) {
      var preloaderText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'default';
      if (!elementToShowReloader) return;
      var textToRender = 'Refreshing page ...';
      if (preloaderText !== 'default' && typeof preloaderText === 'string') textToRender = preloaderText;
      var originalHTML = elementToShowReloader.html(); // if (!element)
      // let preloader = `          
...
var _default = SearchPageView;
exports.default = _default;
},{}],"search/searchPageController.js":[function(require,module,exports) {
"use strict";
...
var _PostView = _interopRequireDefault(require("./../post//PostView"));

var _PostHTMLCreator = _interopRequireDefault(require("./../post//PostHTMLCreator"));

var _outputUsers = require("../user/outputUsers");

var _createUserHtml = require("../user/createUserHtml");

var _searchPageModel = _interopRequireDefault(require("./searchPageModel"));

var _searchPageView = _interopRequireDefault(require("./searchPageView"));
...
var postView = new _PostView.default();
var timer_executeSearch;

var SearchPageController = /*#__PURE__*/function () {
  ...
  _createClass(SearchPageController, [{
    key: "_searchBoxTypingEvent",
    value: function _searchBoxTypingEvent() {
      return $("input#searchBox").on('keydown', function (event) {
        var searchField = $(event.target);
        var searchValue = searchField.val();
        var searchType = searchField.data().search_type;
        var searchResults;
        var resultContainer = $('.resultsContainer');

        _searchPageView.default.showSearchPreloader(resultContainer, 'Searching...'); // 清除現有 timer_executeSearch


        clearTimeout(timer_executeSearch); // 重設一個新 timer_executeSearch 

        timer_executeSearch = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var postHtmlArray;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  _context.next = 7;
                  return _searchPageModel.default.searchUserOrPostByType(searchValue, searchType);

                case 7:
                  searchResults = _context.sent;

                  if (searchType === 'posts') {
                    postHtmlArray = searchResults.map(function (post) {
                      return _PostHTMLCreator.default.convertPostToHtml(post);
                    });
                    postView.outputPostHTMLInContainer(postHtmlArray, $(".resultsContainer"), "No results Found. Try different keyword?");
                  } else {
                    (0, _outputUsers.outputUsersInContainer)(searchResults, $(".resultsContainer"));
                  }
    ...
    key: "_searchUser",
    value: function _searchUser() {
      return $("#userSearchTextbox").on('keydown', function (event) {
        ...
        timer_executeSearch = setTimeout(function () {
...
function outputSelectableUsers(results, container) {
  ...
  results.forEach(function (result) {
    ...
    var html = (0, _createUserHtml.createUserHtml)(result, false);
    var element = $(html);
...
var _default = SearchPageController;
exports.default = _default;
},{"./../post//PostView":"post/PostView.js","./../post//PostHTMLCreator":"post/PostHTMLCreator.js","../user/outputUsers":"user/outputUsers.js","../user/createUserHtml":"user/createUserHtml.js","./searchPageModel":"search/searchPageModel.js","./searchPageView":"search/searchPageView.js"}],"profile/profilePageView.js":[function(require,module,exports) {
"use strict";
...
var ProfileView = /*#__PURE__*/function () {
  ...
  _createClass(ProfileView, null, [{
    key: "updateFollowBtn",
    value: function updateFollowBtn(followBtn, isForFollowing) {
      if (isForFollowing) {
    ...
    key: "showPreloaderInFollowButton",
    value: function showPreloaderInFollowButton(buttonElement) {
    ...
    key: "clearPreloaderInFollowButton",
    value: function clearPreloaderInFollowButton(buttonElement) {
      var customMessage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      if (!element) return;
      buttonElement.html(customMessage);
    }
  }, {
    key: "showPreloaderInContainer",
    value: function showPreloaderInContainer(containerElement) {
      var textToRender = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Loading';
      if (!containerElement) return;
      var originalHTML = containerElement.html(); // if (!element)
    ...
    key: "showNoPostResult",
    value: function showNoPostResult() {
      var containerElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $(".postsContainer");
      var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var messageToShow = message === '' ? 'No post from current user' : message;
      containerElement.html("\n            <p class='noResults'>\n               ".concat(messageToShow, "\n            </p>\n        "));
    }
  }, {
    key: "outputPinnedPost",
    value: function outputPinnedPost(pinnedPostHtml, container) {
      container.html("");
      container.append(pinnedPostHtml);
    }
  }, {
    key: "outputPostsExceptForPinned",
    value: function outputPostsExceptForPinned(dataToOutput, container) {
      container.html("");
      ...
      dataToOutput.forEach(function (result) {
...
_defineProperty(ProfileView, "outputUsersHTML", function (results, container) {
  container.html("");
  if (!Array.isArray(results)) return console.log('(from outputUsersHTML:) results is not Array');
  results.forEach(function (result) {
    var html = ProfileView.createUserHtml(result, true);
    container.append(html);
  });
...
_defineProperty(ProfileView, "createUserHtml", function () {
  var userData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Object.assign({
    userName: null
  });
  var toShowFollowButton = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  if (userData === undefined || userData.userName === null) return console.log('(createUserHtml:) please pass in valid user data object');
  var fullName = userData.firstName + " " + userData.lastName; // userLoggedIn 是 global variable

  var isFollowing = userLoggedIn.following && userLoggedIn.following.includes(userData._id);
  var buttonText = isFollowing ? "Following" : "Follow user";
  var buttonClass = isFollowing ? "followButton following" : "followButton";
  var buttonTitle = isFollowing ? "Click to un-follow user" : "Click to follow user";
  var followButton = ""; // userLoggedIn 是 global variable
  // showFollowButton 為 false 的話就不顯示

  if (userLoggedIn._id != userData._id && toShowFollowButton) {
    followButton = "\n            <div class='followButtonContainer'>\n                <button\n                    class='".concat(buttonClass, " follow-btn' \n                    data-user='").concat(userData._id, "'\n                    title='").concat(buttonTitle, "'\n                >\n                        ").concat(buttonText, "\n                </button>\n            </div>\n            ");
  }

  return "<div class='user'>\n                <div class='profileImageContainer'>\n                    <img src='".concat(userData.profilePic, "'>\n                </div>\n                <div class='userDetailsContainer'>\n                    <div class='header'>\n                        <a href='/profile/").concat(userData.userName, "'>").concat(fullName, "</a>\n                        <span class='username'>@").concat(userData.userName, "</span>\n                    </div>\n                </div>\n                ").concat(followButton, "\n            </div>");
});
},{"./../post//PostHTMLCreator":"post/PostHTMLCreator.js"}],"profile/ProfilePageModel.js":[function(require,module,exports) {
"use strict";
...
var _profilePageView = _interopRequireDefault(require("./profilePageView"));
...
var ProfilePageModel = /*#__PURE__*/function () {
  function ProfilePageModel() {
    _classCallCheck(this, ProfilePageModel);
  }

  _createClass(ProfilePageModel, null, [{
    key: "sendFollowUserRequest",
    value: function sendFollowUserRequest(userIdToFollow, followBtn) {
      _profilePageView.default.showPreloaderInFollowButton(followBtn);

      return $.ajax({
        url: "/api/users/".concat(userIdToFollow, "/follow"),
        type: "PUT",
        success: function success(updateUserData, status, xhr) {
          if (xhr.status === 404) return alert("user not found");
          var numberToUpdate = 1;
          var isFollowing = false;

          if ( // 如果確認目前使用者的追蹤者清單 (.following array) 
          // 已經有了要追蹤的 user id
          updateUserData.following && updateUserData.following.includes(userIdToFollow)) {
            isFollowing = true;
            socket.emitNoticeViaSocketToUser(userIdToFollow);

            _profilePageView.default.updateFollowBtn(followBtn, isFollowing);
          }

          _profilePageView.default.updateFollowBtn(followBtn, isFollowing);

          numberToUpdate = -1;
          var label = $("#followersLabel "); // 檢查 followersLabel 存在，因為其他的頁面就不用去抓 #followersValue

          if (label.length != 0) {
            var currentFollowerNumber = parseInt(label.text()); // 將 followersLabel 顯示數字 + 1
    ...
    key: "getPinnedPost",
    value: function () {
      var _getPinnedPost = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(profileId) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 2:
                return _context.abrupt("return", $.get("/api/posts", {
                  postedBy: profileId,
                  pinned: true
                }, function (results) {
      ...
      function getPinnedPost(_x) {
        return _getPinnedPost.apply(this, arguments);
      }

      return getPinnedPost;
    }()
  }, {
    key: "getPostsNotPinnedOrReplies",
    value: function () {
      var _getPostsNotPinnedOrReplies = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(profileId) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
      ...
      function getPostsNotPinnedOrReplies(_x2) {
        return _getPostsNotPinnedOrReplies.apply(this, arguments);
      }

      return getPostsNotPinnedOrReplies;
    }()
  }, {
    key: "convertPostsToHtml",
    value: function convertPostsToHtml(postsData) {
      if (!Array.isArray(postsData)) return console.warn("Need postData in array format to convert", postsData);
    ...
    key: "getReplyPosts",
    value: function () {
      var _getReplyPosts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(profileId) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
      ...
      function getReplyPosts(_x3) {
        return _getReplyPosts.apply(this, arguments);
      }
    ...
    key: "getFollowers",
    value: function () {
      var _getFollowers = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(profileId) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
              ...
              case 2:
                _context4.next = 4;
                return $.get("/api/users/".concat(profileId, "/followers"), function (results) {
                  // outputUsersHTML(
                  //   results.followers,
                  //   $(".resultsContainer"));
                  console.log('傳回的資料');
    ...
    key: "getFollowing",
    value: function () {
      var _getFollowing = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(profileId) {
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
              ...
              case 2:
                _context5.next = 4;
                return $.get("/api/users/".concat(profileId, "/following"), function (results) {
                  // outputUsersHTML(
                  //   results.followers,
                  //   $(".resultsContainer"));
                  console.log('傳回的資料');
    ...
    key: "getProfileIdFromPage",
    value: function getProfileIdFromPage() {
      var profileIdElement = $('.userProfileToView-id');
    ...
    key: "getProfilePageTabOption",
    value: function getProfilePageTabOption() {
      var optionElement = $('.optionOfProfilePageTab');
    ...
    key: "getFollowerPageTabOption",
    value: function getFollowerPageTabOption() {
      var optionElement = $('.optionOfFollowerPageTab');
...
exports.default = ProfilePageModel;
},{"./../clientSideSocket.io/SocketIoController":"clientSideSocket.io/SocketIoController.js","./profilePageView":"profile/profilePageView.js","./../post/PostHTMLCreator":"post/PostHTMLCreator.js"}],"profile/profilePageController.js":[function(require,module,exports) {
"use strict";
...
var _postController = _interopRequireDefault(require("./../post//postController"));

var _PostHTMLCreator = _interopRequireDefault(require("./../post/PostHTMLCreator"));

var _ProfilePageModel = _interopRequireDefault(require("./ProfilePageModel"));
...
var ProfilePageController = /*#__PURE__*/function () {
  function ProfilePageController() {
    _classCallCheck(this, ProfilePageController);

    this._initProfilePageEventListeners();
  } // 進入 URL /profile 的時候將 post 內容輸出到使用者 profile 頁面


  _createClass(ProfilePageController, [{
    key: "renderProfilePage",
    value: function renderProfilePage() {
      var profileId = _ProfilePageModel.default.getProfileIdFromPage();

      var optionOfPageTabs = _ProfilePageModel.default.getProfilePageTabOption();
    ...
    key: "renderPostsInProfilePage",
    value: function () {
      var _renderPostsInProfilePage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(profileId) {
        var $postContainer, $pinnedPostContainer, pinnedPost, otherPosts, pinnedHtml, otherPostAsHtml;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", console.error('need to pass in profileId for "renderPostsInProfilePage"'));

              case 2:
                // 1) Show preloader while fetching data
                _GlobalView.default.showPreloaderInElement($(".postsContainer"), 'Loading', 1);

                $postContainer = $(".postsContainer");
                $pinnedPostContainer = $(".pinnedPostContainer");
                _context.next = 7;
                return _ProfilePageModel.default.getPinnedPost(profileId);

              case 7:
                pinnedPost = _context.sent;
                _context.next = 10;
                return _ProfilePageModel.default.getPostsNotPinnedOrReplies(profileId);

              case 10:
                otherPosts = _context.sent;
                // 2) Convert and render pinned post
                pinnedHtml = _ProfilePageModel.default.convertPostsToHtml(pinnedPost);

                _profilePageView.default.outputPinnedPost(pinnedHtml, $pinnedPostContainer); // 3) Convert and render OTHER posts 


                otherPostAsHtml = _ProfilePageModel.default.convertPostsToHtml(otherPosts);
                $postContainer.html(otherPostAsHtml); // 4) Show 'no results found'

                if (pinnedPost.length === 0 && otherPosts.length === 0) _profilePageView.default.showNoPostResult();
      ...
      function renderPostsInProfilePage(_x) {
        return _renderPostsInProfilePage.apply(this, arguments);
      }

      return renderPostsInProfilePage;
    }()
  }, {
    key: "renderProfilePageWithReplies",
    value: function () {
      var _renderProfilePageWithReplies = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(profileId) {
        var $postContainer, replyPosts, replyPostsHtml;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", console.error('need to pass in profileId for "renderPostsInProfilePage"'));
              ...
              case 2:
                ...
                $postContainer = $(".postsContainer");
                _context2.next = 6;
                return _ProfilePageModel.default.getReplyPosts(profileId);

              case 6:
                replyPosts = _context2.sent;
                replyPostsHtml = _ProfilePageModel.default.convertPostsToHtml(replyPosts);
                $postContainer.html(replyPostsHtml); // outputPostsInContainer(replyPosts, $(".postsContainer"));

                if (replyPosts.length === 0) _profilePageView.default.showNoPostResult($postContainer, 'No reply from this user yet');
      ...
      function renderProfilePageWithReplies(_x2) {
        return _renderProfilePageWithReplies.apply(this, arguments);
      }

      return renderProfilePageWithReplies;
    }() // #1 Function for URL:
    ...
    key: "renderFollowerPage",
    value: function () {
      var _renderFollowerPage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var profileUserId, optionOfPageTabs, renderContainer, userData, _userData;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                profileUserId = _ProfilePageModel.default.getProfileIdFromPage();
                optionOfPageTabs = _ProfilePageModel.default.getFollowerPageTabOption();
                renderContainer = $(".resultsContainer");

                _profilePageView.default.showPreloaderInContainer(renderContainer);
                ...
                _context3.next = 8;
                return _ProfilePageModel.default.getFollowers(profileUserId);

              case 8:
                userData = _context3.sent;

                _profilePageView.default.outputUsersHTML(userData.followers, renderContainer);
              ...
              case 12:
                _context3.next = 14;
                return _ProfilePageModel.default.getFollowing(profileUserId);

              case 14:
                _userData = _context3.sent;

                _profilePageView.default.outputUsersHTML(_userData.following, renderContainer);
      ...
      function renderFollowerPage() {
        return _renderFollowerPage.apply(this, arguments);
      }

      return renderFollowerPage;
    }() // ==== For Event Listeners ====

  }, {
    key: "_initProfilePageEventListeners",
    value: function _initProfilePageEventListeners() {
      var listenersToInit = this._getEventListenersToInit();
    ...
    key: "_getEventListenersToInit",
    value: function _getEventListenersToInit() {
      return [this._clickFollowBtnToFollowUser];
    }
  }, {
    key: "_clickFollowBtnToFollowUser",
    value: function _clickFollowBtnToFollowUser() {
      $(document).on("click", ".followButton", function (e) {
        var followBtn = $(e.target);
        var userId = followBtn.data().user;

        _ProfilePageModel.default.sendFollowUserRequest(userId, followBtn);
      });
    }
  }]);
...
},{"./../post//postController":"post/postController.js","./../post/PostHTMLCreator":"post/PostHTMLCreator.js","./ProfilePageModel":"profile/ProfilePageModel.js","./profilePageView":"profile/profilePageView.js","./../GlobalControl/GlobalView":"GlobalControl/GlobalView.js"}],"chatList/ChatListView.js":[function(require,module,exports) {
"use strict";
...
var _ChatListModel = _interopRequireDefault(require("./ChatListModel"));
...
var ChatListView = /*#__PURE__*/function () {
  function ChatListView() {
    _classCallCheck(this, ChatListView);
  } // updateSelectedUsersHtml


  _createClass(ChatListView, null, [{
    key: "updateSelectedUsersInInput",
    value: function updateSelectedUsersInInput(selectedUsers) {
      var markupOfSelectedUsers = [];
      selectedUsers.forEach(function (user) {
        var name = user.firstName + " " + user.lastName;
        var userSpanTag = $("<span class='selectedUser'>".concat(name, "</span>"));
    ...
    key: "outputChatList",
    value: function outputChatList() {
      var chatListData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var container = arguments.length > 1 ? arguments[1] : undefined;
      chatListData.forEach(function (chat) {
        var html = _ChatListModel.default.createChatHtml(chat);
    ...
    value: function showPreloaderInElement(preloaderContainer) {
      var preloaderText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'default';
      var preloaderStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      if (!preloaderContainer) return; // check arguments

      var textToRender = typeof preloaderText === 'string' ? preloaderText : 'default';
      var loaderStyleNumber = typeof preloaderStyle === 'number' ? preloaderStyle : 0; // keep original html in element to restore the container later
...
var _default = ChatListView;
exports.default = _default;
},{"./../user/createUserHtml":"user/createUserHtml.js","./ChatListModel":"chatList/ChatListModel.js"}],"chatList/ChatListController.js":[function(require,module,exports) {
"use strict";
...
var _profilePageView = _interopRequireDefault(require("../profile/profilePageView"));

var _ChatListView = _interopRequireDefault(require("./ChatListView"));
...
var currentPagePath = window.location.pathname;
var $containerForList = $(".resultsContainer");
var $userSearchResult = $(".userSearchResultContainer");
var $userSearchResultMessage = $(".userSearchResultMessage");
var timer_executeSearch;
var selectedUsersArray = [];

var ChatListController = /*#__PURE__*/function () {
  function ChatListController() {
    var existingChatList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  ...
  _createClass(ChatListController, [{
    ...
    key: "event_loadChatList",
    value: function event_loadChatList() {
      var _this = this;
      ...
      $( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                existingChatList = _this.existingChatList; // render fetch chat list in page
                ...
                return _context.abrupt("return", _ChatListView.default.outputChatList(existingChatList, $containerForList));

              case 4:
                return _context.abrupt("return", $containerForList.html(_ChatListModel.default.chatListNotFoundMsg()));
    ...
    key: "event_searchUserForNewChat",
    value: function event_searchUserForNewChat() {
      var _this2 = this;

      // avoid conflict with chat list page
      if (!currentPagePath.match(/new/g)) return;
      var existingChatList = this.existingChatList; // render existing chat list as reference

      if (existingChatList && existingChatList.length !== 0) {
        this._showExistingListInSearchPage();
      } else {
        $containerForList.html(_ChatListModel.default.chatListNotFoundMsg());
      } // 3) Handler for search event


      $("#userSearchTextbox").on('keyup', function (event) {
        // 1) Reset UI and clear existing setTimeout function 
        // for event key up      
        clearTimeout(timer_executeSearch);
        $userSearchResult.html(""); // clear previous search result

        $userSearchResultMessage.css('display', 'none'); // 2) Get input value

        var searchInput = $(event.target);
        var searchValue = searchInput.val().trim(); // 3) Show preloader for every keyup

        if (searchValue.length > 0) _this2._showDelayedSearchPreloader('Searching user...'); // 4) When the input is empty and hits backspace, will
        // delete existing and the last selected user from array

        if (searchValue === "" && (event.which === 8 || event.keyCode === 8)) {
          selectedUsersArray.pop();

          _ChatListView.default.updateSelectedUsersInInput(selectedUsersArray); // disable create chat button if array is already empty
        ...
        timer_executeSearch = setTimeout(_this2._searchUserAndRenderResult(searchValue, _this2._renderUserSelectionFunction), 1200);
      });
    }
  }, {
    key: "event_createNewChat",
    value: function event_createNewChat() {
      $("#createChatButton").click(function () {
        // 使用 ajax call之前要先把 array 轉成 json 格式，才能送到後端
        var dataOfUsersInChat = JSON.stringify(selectedUsersArray);
        $.post("/api/chats", {
    ...
    key: "_showDelayedSearchPreloader",
    value: function _showDelayedSearchPreloader(textToShowInPreloader) {
      setTimeout(function () {
        _ChatListView.default.showPreloaderInElement($userSearchResult, textToShowInPreloader, 1);
      }, 500);
    }
  }, {
    key: "_showExistingListInSearchPage",
    value: function _showExistingListInSearchPage() {
      $containerForList.html(""); // empty previous result first

      _ChatListView.default.outputChatList(this.existingChatList, $containerForList);

      $containerForList.prepend("\n      <span class=\"current-existing-chats-label\">\n          Current Existing Chats\n      </span>\n      ");
    }
  }, {
    key: "_searchUserAndRenderResult",
    value: function _searchUserAndRenderResult(searchValue, renderFunction) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _ChatListModel.default.searchUsersForNewChat(searchValue);

              case 3:
                searchResults = _context2.sent;
                // 將查詢到的結果輸出到畫面做為選擇清單
                renderFunction(searchResults, $userSearchResult);
    ...
    key: "_renderUserSelectionFunction",
    value: function _renderUserSelectionFunction() {
      var usersData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var containerAsUserList = arguments.length > 1 ? arguments[1] : undefined;
      containerAsUserList.html("");

      if (usersData.length === 0) {
        containerAsUserList.append("<span class='user-list noResults'>No results found</span>");
        return;
      ...
      usersData.forEach(function (user) {
        ...
        if (user._id === userLoggedIn._id || selectedUsersArray.some(function (userSelected) {
          return userSelected._id === user._id;
        })) {
          return;
        } // (User ProfileView.createUserHtml) to render user in page


        var createdElement = $(_profilePageView.default.createUserHtml(user, true)); // and attach event listen to every result
    ...
    key: "async_build_instance",
    value: function () {
      var _async_build_instance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var chatList, instance;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
              ...
              case 2:
                ...
                _context3.next = 5;
                return _ChatListModel.default.loadChatList();
      ...
      function async_build_instance() {
        return _async_build_instance.apply(this, arguments);
      }

      return async_build_instance;
    }()
  }]);
...
_defineProperty(ChatListController, "_createdSingletonInstance", null);

_defineProperty(ChatListController, "_createdInstanceCounter", 0);

function clickAndAddUserToChat(user) {
  selectedUsersArray.push(user); // Refresh and render latest selection

  _ChatListView.default.updateSelectedUsersInInput(selectedUsersArray); // Reset research input field and button
...
var _default = ChatListController;
exports.default = _default;
},{"../profile/profilePageView":"profile/profilePageView.js","./ChatListView":"chatList/ChatListView.js","./ChatListModel":"chatList/ChatListModel.js"}],"chatRoom/ChatRoomModel.js":[function(require,module,exports) {
"use strict";
...
// there's already a socket.io instance in index.js
// so get the created one in case of bug by creating multiple socket instance
var socket = _SocketIoController.default.getCreatedInstance();

var ChatRoomModel = /*#__PURE__*/function () {
  function ChatRoomModel() {
    _classCallCheck(this, ChatRoomModel);

    var currentPagePath = window.location.pathname;
    var chatIdFromUrl = currentPagePath.split('/')[3];
  ...
  _createClass(ChatRoomModel, [{
    key: "isCurrentlyTyping",
    get: function get() {
    ...
    key: "emitTypingStatusTimer",
    get: function get() {
      return this._emitTypingStatusTimer;
    },
    set: function set(timeoutTimer) {
    ...
    key: "getChatName",
    value: function getChatName(chatData) {
      var chatName = chatData.chatName;

      if (!chatName) {
        var otherChatUsers = getOtherChatUsers(chatData.usersInChat);
    ...
    key: "createLocalMessage",
    value: function createLocalMessage(newMessage) {
      var localMessage = {
        "content": newMessage,
        "_id": "localMessage",
        "createdByUser": userLoggedIn._id,
        "createdAt": new Date().toISOString(),
        "sender": _defineProperty({
    ...
    key: "convertMessageDataToJoinHTML",
    value: function convertMessageDataToJoinHTML(messagesData) {
      var _this = this;

      var messageHtmlArray = [];
      var lastSenderId = "";
      messagesData.forEach(function (message, i) {
        var createdHtml = _this.createMessageHtml(message, messagesData[i + 1], lastSenderId); // 4-2) 將 html 放入  messageHtmlArray


        messageHtmlArray.push(createdHtml); // 4-3) 更新 lastSenderId

        lastSenderId = message.sender._id;
      });
      var joinedMessageHtml = messageHtmlArray.join("");
      return joinedMessageHtml;
    } // async operation

  }, {
    key: "updateChatNameViaAPI",
    value: function updateChatNameViaAPI() {
      var _this2 = this;

      var newChatName = $("#changeChatTitleTextbox").val().trim();
      return new Promise(function (res, rej) {
        $.ajax({
          url: "/api/chats/" + _this2.chatId,
          type: "PUT",
          data: {
    ...
    key: "getChatMessagesFromDB",
    value: function getChatMessagesFromDB() {
      var _this3 = this;

      return new Promise(function (res, rej) {
        $.get("/api/chats/".concat(_this3.chatId, "/messages")).done(function (data, statusText, xhr) {
          var status = xhr.status; //200

          var head = xhr.getAllResponseHeaders(); // Detailed header nfo          
    ...
    key: "getChatNameViaAPI",
    value: function getChatNameViaAPI(chatId) {
      if (!chatId) throw Error('Need chatId for ChatRoomView.getChatNameViaAPI()');
      return new Promise(function (res, rej) {
        $.ajax({
    ...
    key: "sendNewMessageToApi",
    value: function sendNewMessageToApi(newMessage) {
      var _this4 = this;
    ...
    value: function () {
      var _markAllMessagesAsRead = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this5 = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (res, rej) {
                  try {
                    $.ajax({
                      url: "/api/chats/".concat(_this5.chatId, "/messages/markAsRead"),
                      type: "PUT",
      ...
      function markAllMessagesAsRead() {
        return _markAllMessagesAsRead.apply(this, arguments);
      }
    ...
    key: "getOtherChatUsers",
    value: function getOtherChatUsers(users) {
      if (users.length === 1) return users;
      return users.filter(function (user) {
        return user._id != userLoggedIn._id;
      });
    ...
    key: "getUserChatImageElement",
    value: function getUserChatImageElement(user) {
    ...
    value: function createMessageHtml(message, nextMessage, lastSenderId) {
      if (message._id === undefined) throw Error('please make sure that the passed in "message" obj is a valid message document from mongoDB ');
      var sender = message.sender;
      var senderName = sender.firstName + " " + sender.lastName;
      var currentSenderId = sender._id; // console.log('current nextMessage:', nextMessage);

      var nextSenderId = nextMessage === null || nextMessage === undefined ? "" : nextMessage.sender._id; // Find out if current message is first or last message 
      // around neighboring message blocks

      var isFirstMsgFromSameUser = lastSenderId !== currentSenderId;
      var isLastMsgFromSameUser = nextSenderId !== currentSenderId;
      var msgIsFromCurrentUser = currentSenderId === userLoggedIn._id;
      var msgIsFromOtherUser = currentSenderId !== userLoggedIn._id;
      var liClassName = msgIsFromCurrentUser ? "mine" : "theirs"; // 顯示其他人訊息的使用者名稱
      ...
      if (isFirstMsgFromSameUser) {
        ...
        if (!msgIsFromCurrentUser) {
          userNameMarkup = "<span class='senderName'>".concat(senderName, "</span>");
        }
      } // 使用者頭像
      ...
      if (isLastMsgFromSameUser) {
        liClassName += " last";
        profileImgInMsg = "<img src='".concat(sender.profilePic, "'>");
      } // 是否在訊息顯示使用者頭像


      var imageContainerMarkup = "";

      if (msgIsFromOtherUser) {
        imageContainerMarkup = "\n        <div class='imageContainer'>\n          ".concat(profileImgInMsg, "\n        </div>");
      }

      return "<li class='message ".concat(liClassName, "'>\n                ").concat(imageContainerMarkup, "\n                <div class='messageContainer'>\n                    ").concat(userNameMarkup, "\n                    <span class='messageBody'>\n                        ").concat(message.content, "\n                    </span>\n                </div>\n            </li>");
    }
  }, {
    key: "getUnreadChatData",
    value: function () {
      var _getUnreadChatData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var getUnreadCounts,
            _args2 = arguments;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                getUnreadCounts = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : false;
      ...
      function getUnreadChatData() {
        return _getUnreadChatData.apply(this, arguments);
      }

      return getUnreadChatData;
    }()
  }, {
    key: "updateTypingStatus",
    value: function updateTypingStatus() {
      if (!socket.isConnected) return; // console.log('updateTypingStatus called');
      // clear timer that might have been set before

      clearTimeout(this.emitTypingStatusTimer); // only emit event when user is not typing
    ...
    key: "setEmitTypingStatusTimer",
    value: function setEmitTypingStatusTimer() {
      var _this6 = this;

      var timerLength = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2000;
      this.emitTypingStatusTimer = setTimeout(function () {
        console.log('emit stop typing event to socket');
        socket.emit("stop typing", _this6.chatId);
        _this6.isCurrentlyTyping = false;
      }, timerLength);
    }
  }]);
...
var _default = ChatRoomModel;
exports.default = _default;
},{"./../clientSideSocket.io/SocketIoController":"clientSideSocket.io/SocketIoController.js"}],"chatRoom/ChatRoomView.js":[function(require,module,exports) {
"use strict";
...
var _ChatRoomModel = _interopRequireDefault(require("./ChatRoomModel"));
...
var chatRoomModel = new _ChatRoomModel.default();

var ChatRoomView = /*#__PURE__*/function () {
  ...
  _createClass(ChatRoomView, [{
    key: "chatId",
    get: function get() {
      return this._chatId;
    }
  }, {
    key: "refreshChatTitle",
    value: function () {
      var _refreshChatTitle = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var chatTitle;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return chatRoomModel.getChatNameViaAPI(this.chatId);

              case 4:
                chatTitle = _context.sent;
      ...
      function refreshChatTitle() {
        return _refreshChatTitle.apply(this, arguments);
      }

      return refreshChatTitle;
    }()
  }, {
    key: "scrollToBottom",
    value: function scrollToBottom() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$elementToScroll = _ref.elementToScroll,
          elementToScroll = _ref$elementToScroll === void 0 ? $(".MessageArea") : _ref$elementToScroll;

      var scrollHeight = elementToScroll[0].scrollHeight;
    ...
    key: "addMessagesHtmlToPage",
    value: function addMessagesHtmlToPage(messageHtml) {
      var element = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $(".MessageArea");
      element.append(messageHtml);
    }
  }, {
    key: "clearMessageInputArea",
    value: function clearMessageInputArea() {
...
var _default = ChatRoomView;
exports.default = _default;
},{"./ChatRoomModel":"chatRoom/ChatRoomModel.js"}],"chatRoom/ChatRoomSocketEvent.js":[function(require,module,exports) {
"use strict";
...
var _ChatRoomView = _interopRequireDefault(require("./ChatRoomView"));
...
// Create new Class instance in ChatRoomController constructor function
var chatRoomModel;
var isInChatRoomPage = window.location.pathname.includes('chatRoom');

var ChatRoomSocketEvent = /*#__PURE__*/function () {
  function ChatRoomSocketEvent() {
    _classCallCheck(this, ChatRoomSocketEvent);
  ...
  _createClass(ChatRoomSocketEvent, [{
    key: "incomingEventHandler",
    value: function incomingEventHandler() {
      ...
      socket.on(_eventNames.socketEventNames.newChatMessageToClient, function (newMessage) {
        ...
        var messagesHTML = chatRoomModel.createMessageHtml(newMessage, null, "" // output only one received message
        );
  ...
  return ChatRoomSocketEvent;
}();

exports.default = ChatRoomSocketEvent;
},{"./../clientSideSocket.io/SocketIoController":"clientSideSocket.io/SocketIoController.js","./../../../server/socket.io/eventNames":"../../server/socket.io/eventNames.js","./ChatRoomView":"chatRoom/ChatRoomView.js","./ChatRoomModel":"chatRoom/ChatRoomModel.js"}],"chatRoom/ChatRoomController.js":[function(require,module,exports) {
"use strict";
...
var _ChatRoomSocketEvent = _interopRequireDefault(require("./ChatRoomSocketEvent"));
...
var ChatRoomController = /*#__PURE__*/function () {
  function ChatRoomController() {
    ...
    chatRoomView = new _ChatRoomView.default();
    chatRoomModel = new _ChatRoomModel.default();
    socketEventHandlers = new _ChatRoomSocketEvent.default();
  }
  ...
  _createClass(ChatRoomController, [{
    ...
    key: "renderChatRoomPage",
    value: function renderChatRoomPage() {
      var _this = this;

      // equals to $(document).ready(...)
      $( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var $messageArea, messagesData, messageHtml, unreadMessageCounts;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", console.warn("can't find chatId for updateChatRoomTitleEvent"));

              case 2:
                $messageArea = $(".MessageArea"); // socket.emit("join room", this.chatId); // 1) 加入後端的socket emit room

                socket.emit(_eventNames.socketEventNames.startChatById, _this.chatId);
                _context.next = 6;
                return chatRoomView.refreshChatTitle();

              case 6:
                _context.next = 8;
                return chatRoomModel.getChatMessagesFromDB();

              case 8:
                messagesData = _context.sent;
                // console.log('messagesData', messagesData);
                messageHtml = chatRoomModel.convertMessageDataToJoinHTML(messagesData); // 3) 將訊息html置入$messageArea
                ...
                $(".messagesContainer").css("visibility", "visible"); // 5) send request to mark all message as read (because fetched and read all messages)

                _context.next = 16;
                return chatRoomModel.markAllMessagesAsRead();
              ...
              case 16:
                ...
                _context.next = 19;
                return chatRoomModel.getUnreadChatData();

              case 19:
                unreadMessageCounts = _context.sent;

                _GlobalView.default.refreshMessagesBadge(unreadMessageCounts);
    ...
    key: "updateChatRoomTitleEvent",
    value: function updateChatRoomTitleEvent() {
      if (!this.chatId) return console.warn('can\'t find chatId for updateChatRoomTitleEvent');
      $("#chatNameChangeButton").on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var successful;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _profilePageView.default.showPreloaderInFollowButton($('#chatNameChangeButton'));

                _context2.next = 3;
                return chatRoomModel.updateChatNameViaAPI();
              ...
              case 3:
                ...
                if (successful) {
                  ...
                  $('#changeChatNameModal').modal('hide'); // use alert from GlobalView Class to reuse code created before
                  ...
                  _GlobalView.default.showAlert({
                    ...
                    slideIn: true,
                    timeToDisappear: 2000 // closeManually: true,
    ...
    key: "sendMessageWithClickEvent",
    value: function sendMessageWithClickEvent() {
      var _this2 = this;

      $(".sendMessageButton").on('click', function () {
        socket.emit("stop typing", _this2.chatId); //send stop typing right after

        _this2.sendMessageAction();
      });
    }
  }, {
    key: "typingInTextareaEvent",
    value: function typingInTextareaEvent() {
      var _this3 = this;

      $("textarea.messageInput").on('keydown', function (event) {
        chatRoomModel.updateTypingStatus();

        if (event.which === 13) {
          socket.emit("stop typing", _this3.chatId);

          _this3.sendMessageAction();
    ...
    key: "sendMessageAction",
    value: function () {
      var _sendMessageAction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var newMessage, localMessage, messageDiv, messageCreatedInDB;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", console.warn("\u627E\u4E0D\u5230chatId\uFF0C\u505C\u6B62\u57F7\u884C sendMessageAction"));

              case 2:
                // 1) get input message
                newMessage = $(".messageInput").val().trim();
                ...
                return _context3.abrupt("return", console.log("can't create a empty message"));

              case 5:
                // 2) 清空輸入區塊 clear input textarea
                chatRoomView.clearMessageInputArea(); // 3) Use input to create new message in page (messageDiv) and in database

                localMessage = chatRoomModel.createLocalMessage(newMessage); // Use localMessage To add new div to page instead of waiting for the message created in database. Will be no delay after sending message so will provide better experience

                messageDiv = chatRoomModel.createMessageHtml(localMessage, null, userLoggedIn._id);
                chatRoomView.addMessagesHtmlToPage(messageDiv);
                chatRoomView.scrollToBottom();
                _context3.next = 12;
                return chatRoomModel.sendNewMessageToApi(newMessage);

              case 12:
                messageCreatedInDB = _context3.sent;

                // 4) send socket event & update UI
                if (messageCreatedInDB) {
                  socket.emit(_eventNames.socketEventNames.newChatMessageFromClient, messageCreatedInDB);
                }
      ...
      function sendMessageAction() {
        return _sendMessageAction.apply(this, arguments);
      }
...
var _default = ChatRoomController;
exports.default = _default;
},{"./ChatRoomView":"chatRoom/ChatRoomView.js","./ChatRoomModel":"chatRoom/ChatRoomModel.js","./ChatRoomSocketEvent":"chatRoom/ChatRoomSocketEvent.js","./../profile/profilePageView":"profile/profilePageView.js","./../GlobalControl/GlobalView":"GlobalControl/GlobalView.js","./../clientSideSocket.io/SocketIoController":"clientSideSocket.io/SocketIoController.js","./../../../server/socket.io/eventNames":"../../server/socket.io/eventNames.js"}],"../../node_modules/cropperjs/dist/cropper.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
 * Cropper.js v1.5.11
...
},{}],"image-uploader/imageUploadController.js":[function(require,module,exports) {
"use strict";
...
var ImageUploader = /*#__PURE__*/function () {
  ...
  _createClass(ImageUploader, [{
    key: "_initEvenListener",
    value: function _initEvenListener() {
      var eventListenersList = this._getListOfEventListener();

      eventListenersList.forEach(function (eventListener) {
        eventListener.call();
      });
    }
  }, {
    key: "_getListOfEventListener",
    value: function _getListOfEventListener() {
      return [this._edit__ProfileImage, this._uploadProfileImage, this._edit__ProfileCover, this._uploadProfileCover];
    }
  }, {
    key: "_edit__ProfileImage",
    value: function _edit__ProfileImage() {
      return $("#profileImageUploadInput").on('change', function () {
        console.log('#profileImageUploadInput 讀取新圖片!');

        if (this.files && this.files[0]) {
          var file = this.files[0];
          console.log('fetched file', file); // 透過 Web API FileReader Class 來讀取 input 裡面開啟的資料
          // ref: https://developer.mozilla.org/en-US/docs/Web/API/FileReader/onload

          var reader = new FileReader();

          reader.onload = function (e) {
            console.log('image is loaded: ', e.target); // 將透過 input 取得的圖檔顯示在.imagePreviewContainer區塊中的img#imagePreview

            var imageReviewInPage = $('img#imagePreview').attr('src', e.target.result); // Cropper Js 如果已經存在於 global 變數 "cropper" 裡面，
            ...
            cropper = new _cropperjs.default(imageReviewInPage[0], {
    ...
    key: "_uploadProfileImage",
    value: function _uploadProfileImage() {
      return $("#imageUploadButton").click(function () {
        ...
        canvas.toBlob(function (blob) {
          ...
          $.ajax({
            ...
            data: formData,
            processData: false,
            // 強制 jQuery 不要轉成 string
            contentType: false,
            // 強制 jQuery 不要指定 content type
            success: function success() {
    ...
    key: "_edit__ProfileCover",
    value: function _edit__ProfileCover() {
      $("#coverPhoto").change(function () {
        if (this.files && this.files[0]) {
          ...
          reader.onload = function (e) {
            ...
            cropper = new _cropperjs.default(image, {
              aspectRatio: 16 / 9,
              background: false
            });
          };
    ...
    key: "_uploadProfileCover",
    value: function _uploadProfileCover() {
      $("#uploadCoverPhotoButton").click(function () {
        var canvas = cropper.getCroppedCanvas();
...
},{"cropperjs":"../../node_modules/cropperjs/dist/cropper.js"}],"notification/NotificationView.js":[function(require,module,exports) {
"use strict";
...
var NotificationView = /*#__PURE__*/function () {
  function NotificationView() {
    _classCallCheck(this, NotificationView);
  }

  _createClass(NotificationView, [{
    key: "outputNotificationList",
    value: function outputNotificationList() {
      var notificationsList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var container = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $(".resultsContainer");
      notificationsList.forEach(function (notificationsHtml) {
    ...
    key: "makeReadAllButtonActive",
    value: function makeReadAllButtonActive() {
      var btn = $('#markNotificationsAsRead');
      btn.addClass('active');
...
},{}],"notification/NotificationController.js":[function(require,module,exports) {
"use strict";
...
var _NotificationModel = _interopRequireDefault(require("./NotificationModel"));

var _NotificationView = _interopRequireDefault(require("./NotificationView"));
...
var notificationModel = new _NotificationModel.default();
var NotificationView = new _NotificationView.default();
var currentPagePath = window.location.pathname;
...
var NotificationController = /*#__PURE__*/function () {
  function NotificationController() {
    ...
    if (!currentPagePath.match(/notifications/g)) return console.warn("must run NotificationController in notification page!");
  ...
  _createClass(NotificationController, [{
    key: "loadNotificationPageEvent",
    value: function loadNotificationPageEvent() {
      var _this = this;
      ...
      _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var resultContainer, notifications, notificationsHtmlArray;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // 1) Show Preloader
                _GlobalView.default.showPreloaderInElement(resultContainer, 'Loading notifications...', 1); // 2) Get data and container for rendering results


                resultContainer = $(".resultsContainer");
                _context.next = 4;
                return notificationModel.getAllNotification();
              ...
              case 4:
                ...
                if (notifications) {
                  ...
                  if (_this.hasUnOpened(notifications)) NotificationView.makeReadAllButtonActive(); // Convert and render results

                  notificationsHtmlArray = notifications.map(function (n) {
                    return notificationModel.convertNoticeToPopupHtml(n);
                  });
                  NotificationView.outputNotificationList(notificationsHtmlArray, resultContainer);
                }
    ...
    key: "makeAllNotificationReadEvent",
    value: function makeAllNotificationReadEvent() {
      $(document).on("click", "#markNotificationsAsRead.active", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var confirm, isSuccessful;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                confirm = window.confirm('Are you sure to make all messages opened?');
              ...
              case 3:
                _context2.next = 5;
                return notificationModel.markAllNotificationsOpened();

              case 5:
                isSuccessful = _context2.sent;
                ...
                return _context2.abrupt("return", console.warn("Can make all notifications opened"));
    ...
    key: "clickOneNotificationEvent",
    value: function clickOneNotificationEvent() {
      $(document).on("click", ".notification.active", /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
          var clickedLink, notificationId, linkUrlSaved, isSuccessful;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  e.preventDefault(); // get id in data attribute from a clicked link 

                  clickedLink = e.target.closest("a.notification");
                  notificationId = $(clickedLink).data().id; // return console.warn('notificationId:', notificationId);
                  // save link for redirecting user later

                  linkUrlSaved = $(clickedLink).attr("href"); // update notification via API and wait for result

                  _context3.next = 6;
                  return notificationModel.markNotificationsWithIdOpened(notificationId);

                case 6:
                  isSuccessful = _context3.sent;
      ...
      $(document).on("click", ".notification", /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
          var clickedLink, notificationId;
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  clickedLink = e.target.closest("a.notification");
                  notificationId = $(clickedLink).data().id;
...
},{"./NotificationModel":"notification/NotificationModel.js","./NotificationView":"notification/NotificationView.js","./../GlobalControl/GlobalView":"GlobalControl/GlobalView.js"}],"mePage/mePageView.js":[function(require,module,exports) {
"use strict";
...
var MePageView = /*#__PURE__*/function () {
  ...
  _createClass(MePageView, null, [{
    key: "showFunctionTab",
    value: function showFunctionTab() {
      var tabName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'detail';
      var allItems = $('.function_item');
      var itemToShow = $(".functionsItem_".concat(tabName)); // console.log('selected tab: ', targetTabToShow);

      if (!itemToShow[0]) throw "Can't find the tab element with class name functionsContainer_".concat(tabName);
...
var MePageController = /*#__PURE__*/function () {
  function MePageController() {
    _classCallCheck(this, MePageController);

    if (!currentPagePath.match(/me/g)) return console.warn("must run NotificationController in notification page!");
    this.eventListeners();
  }
...
var _GlobalSocketEventsHandler = _interopRequireDefault(require("./GlobalControl/GlobalSocketEventsHandler"));

var _GlobalViewControl = _interopRequireDefault(require("./GlobalControl/GlobalViewControl"));

var _postController = _interopRequireDefault(require("./post//postController"));

var _searchPageController = _interopRequireDefault(require("./search/searchPageController"));

var _profilePageController = _interopRequireDefault(require("./profile/profilePageController"));

var _ChatListController = _interopRequireDefault(require("./chatList/ChatListController"));

var _ChatRoomController = _interopRequireDefault(require("./chatRoom/ChatRoomController"));

var _imageUploadController = _interopRequireDefault(require("./../js/image-uploader/imageUploadController"));

var _NotificationController = _interopRequireDefault(require("./../js/notification/NotificationController"));

var _mePageController = _interopRequireDefault(require("./../js/mePage/mePageController"));
...
var socket = _SocketIoController.default.build_singleton_instance(); // initial socket.io client side event handler
// globally handle all incoming socket event data or messages


var globalSocketEventsHandler = new _GlobalSocketEventsHandler.default();

var globalViewControl = _GlobalViewControl.default.getSingletonInstance();

$( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var currentPagePath, postController, imageLoader, notificationController, chatListController, profileContentController, ePageController;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          postController = new _postController.default();
          imageLoader = new _imageUploadController.default();
          globalViewControl.refreshNotificationsBadge();
          globalViewControl.refreshMessagesBadge(); // refreshMessagesBadge();
          ...
          if (currentPagePath.match(/notifications/g)) {
            ...
            notificationController = new _NotificationController.default();
          ...
          _context.next = 12;
          return _ChatListController.default.async_build_instance();

        case 12:
          chatListController = _context.sent;

        case 13:
          // === Chat room page ===
          if (currentPagePath.match(/chat/g)) {
            new _ChatRoomController.default();
          } // profileContentController is for "Search" and "Profile" pages
          // that will render user data in page  


          profileContentController = new _profilePageController.default(); // === Search Page ===

          if (currentPagePath.match(/search/g)) {
            new _searchPageController.default(); // let user can follow users shown in search results
